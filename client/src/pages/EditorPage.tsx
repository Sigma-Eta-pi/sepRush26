...
const DEFAULT_CONTENT: Record<PageKey, Record<string, unknown>> = {
  ...
  recruitment: {
    ...
    events: [
      { date: 'October 5, 2026', title: 'Brotherhood Night', description: 'Get to know the brothers of Sigma Eta Pi in a relaxed, social setting.' },
      { date: 'October 6, 2026', title: 'Info Night', description: 'Learn everything about Sigma Eta Pi — our mission, events, and what membership looks like.' },
      { date: 'October 7, 2026', title: 'Alumni Panel + Application Workshop', description: 'Hear from SEP alumni at Google, Amazon, Deloitte, and more. Get help with your application.' },
      { date: 'October 8, 2026', title: 'Shark Tank Night', description: 'Pitch your ideas and show us your entrepreneurial spirit.' },
      { date: 'Coming Soon', title: 'Applications Due', description: 'Application deadline and form will be announced soon. Follow @ucsbsep on Instagram for updates.' },
    ],
  },
};
