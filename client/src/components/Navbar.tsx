  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <div className="mx-4 sm:mx-6 lg:mx-8 mt-4">
        <div className="bg-[#203354] rounded-full shadow-lg border-2 border-[#203354]">
          <div className="flex items-center justify-between h-16 px-6 sm:px-8">
            {/* Logo */}
            <Link href="/" className="flex items-center gap-3 group">
              <div className="w-10 h-10 flex-shrink-0">
                <img src={logoImg} alt="Sigma Eta Pi logo" className="w-full h-full object-contain" style={{ filter: "brightness(0) invert(1)" }} />
              </div>
            ...
            <div className="hidden lg:block">
              <Link
                href="/recruitment"
                className="px-6 py-2 bg-[#EEEADE] text-[#203354] font-bold rounded-full transition-all duration-300 hover:bg-[#D0E4EF] text-sm"
                style={{
                  fontFamily: "'Helvetica Now', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
                  fontSize: "0.75rem",
      ...
      {/* Mobile Menu */}
      {mobileOpen && (
        <div className="lg:hidden mx-4 sm:mx-6 mt-2 bg-[#203354] rounded-2xl shadow-lg border-2 border-[#203354]">
          <div className="px-6 py-4 space-y-1">
            ...
            <div className="pt-2">
              <Link
                href="/recruitment"
                className="block text-center py-3 px-4 bg-[#EEEADE] text-[#203354] font-bold rounded-lg text-sm"
                style={{
                  fontFamily: "'Helvetica Now', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
                  fontSize: "0.75rem",
                  letterSpacing: "0.05em",
